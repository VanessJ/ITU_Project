...
################################################################################
## Form generated from reading UI file 'mainvENfjL.ui'
##
...
"border:none;")
        ...
        icon = QIcon()
        icon.addFile(u":/prefix/menu.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.label.setMaximumSize(QSize(41, 31))
        self.label.setPixmap(QPixmap(u":/prefix/hammer.png"))
        ...
        icon1 = QIcon()
        icon1.addFile(u":/prefix/remove.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/prefix/copy.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/prefix/close.png", QSize(), QIcon.Normal, QIcon.Off)
...
"border:none;")
        ...
        icon4 = QIcon()
        icon4.addFile(u":/prefix/hardware-chip.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/prefix/construct.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/prefix/factory.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.tests_button = QPushButton(self.menu_frame)
        self.tests_button.setObjectName(u"tests_button")
        icon7 = QIcon()
        icon7.addFile(u":/prefix/analytics.png", QSize(), QIcon.Normal, QIcon.Off)
        self.tests_button.setIcon(icon7)
        self.tests_button.setIconSize(QSize(32, 32))

        self.gridLayout.addWidget(self.tests_button, 2, 0, 1, 1)
        ...
        font3.setBold(True)
        font3.setWeight(75)
        self.halls_label.setFont(font3)
        ...
        font4.setBold(True)
        font4.setWeight(75)
        self.add_hall_button.setFont(font4)
        ...
        font5 = QFont()
        font5.setFamily(u"Palace Script MT")
        ...
        self.confirm_add_button.setFont(font4)
        ...
        self.machines_label.setFont(font3)
        ...
        self.add_machine_button.setFont(font4)
        ...
        self.confirm_add_button_2.setFont(font4)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_25.setText(QCoreApplication.translate("MainWindow", u"TESTS                                                                                              ", None))
